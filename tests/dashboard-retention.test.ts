    ...
    const progressRows = [
      {
        ...
        state: "review",
        words: { cefr: "B2", lemma: "forecast1", metadata: null, slug: "forecast1" },
      },
      {
        desired_retention: 0.9,
        ...
        state: "learning",
        words: { cefr: "A2", lemma: "forecast2", metadata: null, slug: "forecast2" },
      },
      {
        desired_retention: 0.9,
        ...
        scheduler_payload: null,
        state: "suspended",
        words: { cefr: "C1", lemma: "forecast3", metadata: null, slug: "forecast3" },
      },
    ];
      ...
      [
        {
          ...
          scheduler_payload: null,
          state: "learning",
          words: { cefr: "B1", lemma: "test", metadata: null, slug: "test" },
        },
        {
          desired_retention: 0.9,
          ...
          scheduler_payload: null,
          state: "learning",
          words: { cefr: "B1", lemma: "test2", metadata: null, slug: "test2" },
        },
      ],
      0.9,
      3,
